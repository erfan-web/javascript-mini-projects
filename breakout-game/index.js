...
function mouseMoveHandler(e) {
  //e.g. e.client=0,canvas.offsetLeft=506
  //e.g. 0 - 506 = -506 -> so paddle don't move
  //e.g. 507-506 == 1 -> so paddle move
  //e.g. canvasWidth=800,relativeX=900 - > so paddle don't move
